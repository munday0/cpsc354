...
\begin{itemize}
  \item bound
  \item binder is (EApp e1 e2)
  \item scope is the contents of the evalCBN function
\end{itemize}
...
\begin{itemize}
  \item bound
  \item binder is (EAbs i e3)
  \item scope is contents of evalCBN function
\end{itemize}
...
\begin{itemize}
  \item bound
  \item binder is (EAbs i e3)
  \item scope is scope is contents of evalCBN function
\end{itemize}
...
\begin{itemize}
  \item bound
  \item binder is subst id
  \item scope is contents of subst function
\end{itemize}
